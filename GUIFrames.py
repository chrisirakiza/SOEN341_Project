...
class RequestReviewPage(Page):
    def __init__(self, root, *args, **kwargs):
        ...
        frame_table.columnconfigure(self.tableCols - 1, weight = 1)
        frame_table.rowconfigure(self.tableRows - 1, weight = 1)
       ...
       # [quoteID, reqID, itemName, itemQuantity, price, generatedBy, managerID, supplierID]
        lbl_id = ctk.CTkLabel(master = frame_table, text = "Quote ID")
        lbl_id.grid(row = 0, column = 0)
        lbl_item = ctk.CTkLabel(master = frame_table, text = "Request ID")
        lbl_item.grid(row = 0, column = 1)
        lbl_qty = ctk.CTkLabel(master = frame_table, text = "Item")
        lbl_qty.grid(row = 0, column = 2)
        lbl_client = ctk.CTkLabel(master = frame_table, text = "Qty")
        lbl_client.grid(row = 0, column = 3)
        lbl_manager = ctk.CTkLabel(master = frame_table, text = "Price")
        lbl_manager.grid(row = 0, column = 4)
        lbl_status = ctk.CTkLabel(master = frame_table, text = "Req Generated By")
        lbl_status.grid(row = 0, column = 5)
        lbl_acccepted_quote = ctk.CTkLabel(master = frame_table, text = "Assigned Manager")
        lbl_acccepted_quote.grid(row = 0, column = 6)
        lbl_acccepted_quote = ctk.CTkLabel(master = frame_table, text = "Quote Generated By")
